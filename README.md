...
<<<<<<< HEAD
Торговый бот для автоматической торговли на основе сигналов от TradingView.
...
2. **Установите зависимости**
>>>>>>> 423808b (Initial commit: Trading Bot v3.0)
2. **Установите зависимости**
```bash
...
- `usdt_amount` - сумма в USDT для покупки (только для buy)
- `exchange` - биржа: "bybit" или "binance" (опционально)

### API Endpoints

- `GET /` - статус бота
- `POST /webhook` - webhook для сигналов TradingView
...
- Webhook защищён секретным ключом
- Ограничение позиции 10% от баланса
- Логирование всех операций

## Логи

Логи сохраняются в файл `bot.log` с ротацией каждые 10 МБ и хранением 7 дней.
=======
3. **Настройте переменные окружения**
```bash
cp .env.example .env
